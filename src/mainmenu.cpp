...
int mainmenu(SDL_Renderer *renderer) {
	...
	loadPNGImageToTexture(renderer, &astroshark_title.dstrect.w, &astroshark_title.dstrect.h, &astroshark_titleTexture, "resources/gfx/astroshark_title_740x95.png");
